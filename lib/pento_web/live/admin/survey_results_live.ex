defmodule PentoWeb.Live.Admin.SurveyResultsLive do
  ...
  def update(assigns, socket) do
    {:ok,
     socket
     |> assign(assigns)
     |> assign_age_group_filter_by_gender()
     |> assign_age_group_filter()
     |> assign_products_with_average_ratings()
     #  |> assign_products_with_average_ratings_by_gender()
     |> assign_dataset()
     |> assign_chart()
     |> assign_chart_svg()}
  end
  ...
  defp assign_products_with_average_ratings_by_gender(
         %{assigns: %{gender_filter: gender_filter}} = socket
       ) do
    assign(
      socket,
      :products_with_average_ratings,
      get_products_with_average_ratings_by_gender(%{gender_filter: gender_filter})
    )
  end
  ...
  defp get_products_with_average_ratings_by_gender(filter) do
    case Catalog.products_with_average_ratings_by_gender(filter) do
      [] ->
        Catalog.products_with_zero_ratings()
  ...
  def assign_age_group_filter_by_gender(socket) do
    socket
  ...
  def handle_event(
    ...
    {:noreply,
     socket
     |> assign_age_group_filter_by_gender(gender_filter)
     |> assign_products_with_average_ratings_by_gender()
     |> assign_dataset()
     |> assign_chart()
     |> assign_chart_svg()}
  ...
  def assign_age_group_filter_by_gender(socket, gender_filter) do
